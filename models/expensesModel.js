...
exports.saveData = function(expenseData){
  return new Promise(function(resolve, reject){
    ...
    connectDB.query('INSERT INTO users_monthly_in_ex(user_id, uis_id, in_ex_year, in_ex_month, in_ex_date, in_ex_type, in_ex_comment, in_ex_amount) VALUES(?, ?, ?, ?, ?, ?, ?, ?)', expenseData, function(err, res){
        if (err) {
